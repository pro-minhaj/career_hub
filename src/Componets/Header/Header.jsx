...
const Header = () => {
    ...
    return (
        <header className='bg-gradient-to-r from-indigo-100 py-5 md:py-8 rounded-md px-3 md:px-0'>
            <div className="flex items-center justify-between container mx-auto relative">
                ...
                <div className="flex items-center z-10 md:gap-0 gap-4 flex-wrap justify-between px-5 md:px-0">
                    <ul className="flex items-center gap-4 md:gap-10 text-neutral-500 text-base font-medium font-['Manrope'] md:me-20 lg:me-60 xl:me-96 flex-wrap">
                        <li>
                            <Link to="/">Home</Link>
                        </li>
                        <li>
