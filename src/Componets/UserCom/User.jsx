        ...
        <div className='bg-gradient-to-r from-indigo-100'>
            <div className="container mx-auto flex items-center justify-between flex-wrap gap-8 md:gap-0 flex-col-reverse md:flex-row pb-8 md:py-0">
                <div className="w-full md:w-1/2">
                    <h1 className="text-zinc-900 text-5xl md:text-[4.37rem] font-extrabold font-['Manrope'] leading-[80px]">One Step <br /> Closer To Your <br /> <span className='text-indigo-400'>Dream Job</span></h1>
